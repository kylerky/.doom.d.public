...
;; accept. For example:
;;
(setq doom-font (font-spec :family "Fira Code" :size 20.0 :weight 'semi-light)
      doom-variable-pitch-font (font-spec :family "Fira Sans" :size 22.0))
;;
   ...
   (org-roam-capture-templates
    '(("m" "main" plain "%?"
      ...
      ("p" "project" plain "%?"
       ...
       :immediate-finish t
       :unnarrowed t)
      ("b" "Templates for private stuff")
      ("bm" "private main" plain "%?"
       :if-new
       (file+head
