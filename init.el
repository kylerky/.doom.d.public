...
(doom! :input
       ...
       (spell +aspell +everywhere +flyspell) ; tasing you for misspelling mispelling
       ...
       (org +roam +noter +contacts +dragndrop +crypt +gnuplot +present)        ; organize your plain life in plain text
